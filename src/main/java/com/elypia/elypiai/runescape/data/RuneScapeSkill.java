...
public enum RuneScapeSkill {
	...
	RuneScapeSkill(int id, String display, boolean elite) {
		this.id = id;
	...
	public static RuneScapeSkill getById(int id) {
		for (RuneScapeSkill skill : values()) {
			if (skill.getId() == id)
				return skill;
		}
